...
from Scripts.dashboard_shutdown import cleanup_dashboard_components
...
class PredictionModelLauncher:
    ...
    def start_dashboard(self, port=8501, open_browser=True) -> bool:
        ...
        try:
            ...
            # Prepare command path to the dashboard file in the Scripts directory
    ...
    def start_data_processor(self, tickers=None, interval="1d", days_back=365, refresh_rate=3600) -> bool:
        """
        ...
        try:
            ...
            from Scripts.data_manager import process_data_job, stop_processing
            ...
            while True:
                try:
                    ...
                    if cmd == "dashboard":
                        ...
                        open_browser = input("Open browser? (y/n, default y): ").strip().lower()
                        open_browser = False if open_browser == 'n' else True
                        self.start_dashboard(port, open_browser)
                        
                    elif cmd == "train":
                        config = input("Enter config path (or press Enter for default): ").strip()
    ...
    def stop_component(self, component: str):
        ...
        try:
            ...
            thread_name = f"{component}" if component in self.threads else f"{component}_logs"
...
def main():
    ...
    parser.add_argument("--process-data", action="store_true", help="Start data processor")
