...
from Scripts.vectorized_ops import vectorized_sequence_creation, preserve_date_column
from Scripts.data_manager import parse_dates, scale_features_preserve_dates
...
class TestPreprocessing(unittest.TestCase):
    ...
    def test_preprocessing_with_gaps(self) -> None:
        ...
        dates = list(pd.date_range(start='2022-01-01', periods=50)) + \
                list(pd.date_range(start='2022-03-01', periods=50))
