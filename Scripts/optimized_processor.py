...
from config import VMLI_WINDOW_MOM, VMLI_WINDOW_VOL, VMLI_SMOOTH_PERIOD, VMLI_WINSORIZE_PCT, VMLI_USE_EMA  # default values as fallback if needed
from optimized_params import load_optimized_params  # updated relative import
